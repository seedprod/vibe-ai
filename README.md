# Vibe AI - Connect WordPress to Any AI Assistant
...
- **AI Theme Editing** — Draft theme workflow with sandbox, preview URL, and publish
- **Classic Theme Builder** — Create WordPress themes from scratch with AI
- **WP-CLI Commands** — 34 allowlisted commands via native PHP dispatch (no shell execution)
- **AI Screenshots** — Visual feedback via Cloudflare Browser Rendering
- **Advanced Design Skills** — Guided workflows for professional theme development
...
- **No shell execution** — WP-CLI commands dispatch to native WordPress PHP APIs
...
- **Draft theme sandbox** — Theme edits happen in isolation, never touch the live site until you publish
